 ...
 */
@FrameworkComponent
public class UserSystemServiceImpl extends BaseEntitySystemServiceImpl<WaterUser> implements UserSystemApi {
    @Inject
    @Setter
    @Getter
    ...
    public void onActivate(UserRepository userRepository, EncryptionUtil encryptionUtil) {
        try {
            ...
            WaterUser adminUser = new WaterUser("Admin", "Admin", "wadmin", tempPassword, salt, true, "hadmin@water.it");
